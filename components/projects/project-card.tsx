    ...
    return (
        ...
        >
            ...
            <Card className="h-full flex flex-col overflow-hidden bg-card/40 backdrop-blur-md border-border/50 relative z-10 transition-colors duration-500 group-hover:border-primary/30">
                ...
                <div className="relative h-64 md:h-72 w-full overflow-hidden bg-black/20">
                    ...
                    <CardHeader className="p-0 mb-4">
                        <div className="flex justify-between items-start mb-2">
                            ...
                            <div className="flex gap-2">
                                ...
                                <ExternalLink className="text-muted-foreground hover:text-primary transition-colors cursor-pointer" size={20} />
                            </div>
                        </div>
